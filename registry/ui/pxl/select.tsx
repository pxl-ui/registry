...
function SelectTrigger({
  ...
  children,
  ...props
}: SelectPrimitive.Trigger.Props & VariantProps<typeof selectVariants>) {
  return (
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        "top-1.5 z-10 flex w-[calc(100%-(--spacing(3)))] cursor-default items-center justify-center bg-popover py-1 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      className={cn(
        "bottom-1.5 z-10 flex w-[calc(100%-(--spacing(3)))] cursor-default items-center justify-center bg-popover py-1 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
