  ...
  return (
    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <g id="flag">
        ...
        />
        <path id="leonQuarteringBg" fill="#ffffff" d="m 11,8 h 3 v 3 h -3 z" />
        <path id="leonQuarteringFg" fill="#bfbfbf" d="m 12,9 h 1 v 1 h -1 z" />
        <path
...
function UnitedKingdom(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <g id="flag">
        <path id="andrewCrossBg" fill="#142269" d="m 1,1 h 30 v 18 h -30 z" />
        <path
          id="georgeCrossBg"
          fill="#ffffff"
