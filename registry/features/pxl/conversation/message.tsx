...
function MessageAvatar({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex w-fit min-w-8 shrink-0 items-center justify-center self-end overflow-hidden pixel-rounded pixel-size-lg bg-muted group-has-data-[slot=message-footer]/message:-translate-y-8",
        className,
      )}
      {...props}
    />
