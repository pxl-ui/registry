  ...
  return (
    <>
      <TableRow className="align-top">
        <TableCell className="font-mono text-sm">
          ...
          >
            {expandable ? (
              ...
              >
                {open ? (
                  <svg className="size-3.5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"><path d="M17 9v2h-2v2h-2v2h-2v-2H9v-2H7V9h10Z"/></svg>
                ) : (
                  <svg className="size-3.5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"><path d="M9 17h2v-2h2v-2h2v-2h-2V9h-2V7H9v10Z"/></svg>
                )}
              </Button>
            ) : (
        ...
        <TableCell>
          {required && (
            <svg className="size-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"><path d="M10 18H8v-2h2v2Zm-2-2H6v-2h2v2Zm4-2v2h-2v-2h2Zm-6 0H4v-2h2v2Zm8 0h-2v-2h2v2Zm2-2h-2v-2h2v2Zm2-2h-2V8h2v2Zm2-2h-2V6h2v2Z"/></svg>
          )}
        </TableCell>
        ...
        <AccordionItem value={k} key={k}>
          <AccordionTrigger>
            <div>
              ...
              {schema.description && (<p className="font-mono text-sm text-muted-foreground mt-0.5">{schema.description}</p>)}
            </div>
          </AccordionTrigger>
          <AccordionContent>
