...
// biome-ignore lint/complexity/noBannedTypes: base schema
...
function registryI18nSchema() {
  return z.object({
    "registry.credits.author": z.string(),
    "registry.credits.license": z.string(),
