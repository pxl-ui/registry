...
<ComponentPreview item="conversation/message-scroller" />
...
<Install item="conversation/message-scroller" />

## Usage

```tsx
import { Message } from "@/components/features/pxl/conversation/message"
import {
  MessageScroller,
...
```tsx
import { useMessageScroller } from "@/components/features/pxl/chats/message-scroller"
```
...
```tsx
import { useMessageScrollerVisibility } from "@/components/features/pxl/chats/message-scroller"
```
...
```tsx
import { useMessageScrollerScrollable } from "@/components/featurex/pxl/chats/message-scroller"
```
              ...
              {virtualizer.getVirtualItems().map((virtualItem) => {
                ...
                return (
                  <div
                    ...
                    className="absolute inset-s-0 top-0 w-full"
                    style={{
