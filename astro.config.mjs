...
const baseUrl =
  process.env.NODE_ENV === "development" ? undefined : "/registry";
...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      title: "PXL UI",
      description:
        "A UI kit for people making things that blink, bounce, and beep. Sharp pixel edges paired with fluid, modern interaction — nothing here looks like a template, and nothing here should stay looking like ours once you're done with it.",
      head: [
        {
          tag: "link",
          attrs: {
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                label: "Interaction",
                items: [
                  { autogenerate: { directory: "components/interaction" } },
                ],
              },
              {
                label: "Navigation",
